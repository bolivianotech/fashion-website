...
const EMAIL_CONFIG = {
  SERVICE_ID: 'service_904qgx7',
  TEMPLATE_ID: 'template_7cnjwju',
  PUBLIC_KEY: 'PVtEtMLqWCM4-JpSf'
};
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex space-x-6">
              <a href="#colecciones" className="text-white hover:text-gray-200">
                COLECCIONES
              </a>
              <a href="#sobremi" className="text-white hover:text-gray-200">
                SOBRE MÍ
              </a>
              <a href="#contacto" className="text-white hover:text-gray-200">
                CONTACTO
              </a>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                {isSearchOpen && (
                  <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-md shadow-lg p-4">
                    <input
                      type="text"
                      placeholder="Buscar..."
                      value={searchQuery}
              ...
              <div className="relative">
                ...
                {isLanguageMenuOpen && (
                  <div className="absolute right-0 top-full mt-2 w-32 bg-white rounded-md shadow-lg">
                    {languages.map((lang) => (
                      <button
                        key={lang.code}
                        onClick={() => {
              ...
              <div className="relative">
                ...
                >
                  ...
                  {cartItems.length > 0 && (
                    <span className="absolute -top-1 -right-1 bg-yellow-400 text-black w-4 h-4 rounded-full text-xs flex items-center justify-center">
                      {cartItems.length}
                    </span>
                  )}
                </button>
                {isCartOpen && (
                  <div className="absolute right-0 top-full mt-2 w-72 bg-white rounded-md shadow-lg p-4">
                    {cartItems.length === 0 ? (
